		...
		>
			<div className="info-wrapper">
				...
				<div className="text-wrapper">
					<h3 className="center">Denomination Key</h3>
					<p>
					...
					<p>
						<span className="accent">RPCNA</span>: Reformed Presbyterian Church
						in North America
					</p>
					<p>
					...
					<p>
						<span className="accent">ARP</span>: Associate Reformed Presbyterian
						Church
					</p>
					<p>
